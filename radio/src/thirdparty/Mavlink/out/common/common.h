...
#define FASTMAVLINK_BUILD_DATE  "Mon Mar 08 2021"
#endif
...
typedef enum GIMBAL_DEVICE_ERROR_FLAGS {
    ...
    GIMBAL_DEVICE_ERROR_FLAGS_ENUM_END = 257,  // end marker
...
typedef enum COMP_METADATA_TYPE {
    ...
    COMP_METADATA_TYPE_ENUM_END = 3,  // end marker
} COMP_METADATA_TYPE;
#endif
...
typedef enum MAV_BATTERY_FAULT {
    ...
    MAV_BATTERY_FAULT_ENUM_END = 65,  // end marker
} MAV_BATTERY_FAULT;
#endif
...
typedef enum MAV_ODID_ID_TYPE {
    ...
    MAV_ODID_ID_TYPE_ENUM_END = 4,  // end marker
} MAV_ODID_ID_TYPE;
#endif
...
typedef enum MAV_ODID_AUTH_TYPE {
    ...
    MAV_ODID_AUTH_TYPE_ENUM_END = 5,  // end marker
} MAV_ODID_AUTH_TYPE;
#endif
